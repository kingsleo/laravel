{{--<form class="form-horizontal" action="{{ url('student/save') }}">--}}
    <form class="form-horizontal" action="" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" id="age" name="Student[age]" placeholder="请输入学生年龄"  value="{{ old('Student')['age'] ? old('Student')['age'] : $student->age }}">
            </div>
            <div class="col-sm-5">
